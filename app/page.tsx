        ...
        <div className="container mx-auto">
          ...
          <div className="bg-gray-800 rounded-xl shadow-2xl p-12 mb-24">
            ...
            <p className="text-xl text-gray-300 mb-8">
              GLOF-EWS is a cutting-edge project developed as part of Code4change by Team 90mlIodine. Our mission is to leverage advanced technology to protect communities from the devastating impacts of glacial lake outburst floods and other related calamities.
            </p>
            <p className="text-lg text-gray-400">
              Developed with passion and expertise by Gnaneswar Lopinti and the dedicated members of Team 90mlIodine.
            </p>
          </div>
        </div>
      </div>
